		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-sm-10 col-md-8 col-lg-4 p-b-40">
					<div class="bg-0 h-full">
						<a href="news-detail.html" class="hov-img0 of-hidden">
							<img src="{{ asset('theme/cprofile1/images/news-01.jpg') }}" alt="IMG">
						</a>
				...
				<div class="col-sm-10 col-md-8 col-lg-4 p-b-40">
					<div class="bg-0 h-full">
						<a href="news-detail.html" class="hov-img0 of-hidden">
							<img src="{{ asset('theme/cprofile1/images/news-02.jpg') }}" alt="IMG">
						</a>
				...
				<div class="col-sm-10 col-md-8 col-lg-4 p-b-40">
					<div class="bg-0 h-full">
						<a href="news-detail.html" class="hov-img0 of-hidden">
							<img src="{{ asset('theme/cprofile1/images/news-03.jpg') }}" alt="IMG">
						</a>
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-sm-4 col-lg-2 flex-c-c p-b-60">
					<a href="#">
						<img class="hov-img2 trans-02 max-s-full" src="{{ asset('theme/cprofile1/images/icons/partner-01.png') }}" alt="IMG">
					</a>
				</div>

				<div class="col-sm-4 col-lg-2 flex-c-c p-b-60">
					<a href="#">
						<img class="hov-img2 trans-02 max-s-full" src="{{ asset('theme/cprofile1/images/icons/partner-02.png') }}" alt="IMG">
					</a>
				</div>

				<div class="col-sm-4 col-lg-2 flex-c-c p-b-60">
					<a href="#">
						<img class="hov-img2 trans-02 max-s-full" src="{{ asset('theme/cprofile1/images/icons/partner-03.png') }}" alt="IMG">
					</a>
				</div>

				<div class="col-sm-4 col-lg-2 flex-c-c p-b-60">
					<a href="#">
						<img class="hov-img2 trans-02 max-s-full" src="{{ asset('theme/cprofile1/images/icons/partner-04.png') }}" alt="IMG">
					</a>
				</div>

				<div class="col-sm-4 col-lg-2 flex-c-c p-b-60">
					<a href="#">
						<img class="hov-img2 trans-02 max-s-full" src="{{ asset('theme/cprofile1/images/icons/partner-05.png') }}" alt="IMG">
					</a>
				</div>
			</div>
		</div>
				...
				<div class="slide-slick">
						...
						<div class="block3 d-flex">
							<div class="block3-content d-flex">
								<div class="block3-pic wrap-pic-w">
									<img src="{{ asset('theme/cprofile1/images/ava-01.jpg') }}" alt="IMG">
								</div>
					...
					<div class="item-slick p-rl-15 wrap-block3">
						<div class="block3 d-flex">
							<div class="block3-content d-flex">
								<div class="block3-pic wrap-pic-w">
									<img src="{{ asset('theme/cprofile1/images/ava-02.jpg') }}" alt="IMG">
								</div>
